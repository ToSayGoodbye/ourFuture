		   			...
		   			for (var i = 0; i < data.rows.length; i++) {
		   			 ...
		   			 $('<tr>'+
		   		           ...
		   		           '<td>'+data.rows[i].comment+'</td>'+
		   		            ...
		   		            '<td>'+
		   		                '<div class="btn-group">'+
		   		                  '<a onclick="view(\'' +path+ '\',\''+data.rows[i].picture_name+'\')" class="btn btn-default">查看</a>'+'<a href="" class="btn btn-default">下架</a><a onclick="dele(\''+data.rows[i].id+'\')" class="btn btn-danger">删除</a>'+
